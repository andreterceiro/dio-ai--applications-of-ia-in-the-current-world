...
Teacher talked that the robots can be equiped with several types of sensors to get information from the environment. This way a vacuum cleaner can learn paths in the environment as example.